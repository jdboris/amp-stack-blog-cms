...
const WELCOME_MESSAGE = "Follow the development of our games and be the first to hear about new projects, and new worlds to explore.";
?>
...
<html xmlns:v="urn:schemas-microsoft-com:vml">
	...
	<head>
		...
		<title><?= WEBSITE_TITLE ?> Email Verification</title>
						...
						<tr>
							<td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
								...
								<div style="line-height: 35px">
									...
									Welcome to <span style="color: #5caad2;"><?= WEBSITE_TITLE ?></span>
									...
									<tr>
										<td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
											...
											<div style="line-height: 26px;">
												<a href="<?= URL_ROOT ?>verify-email?token=<?= urlencode( $user->emailVerificationToken ) ?>" style="color: #ffffff; text-decoration: none;">VERIFY EMAIL ADDRESS</a>
											</div>
										</td>
									</tr>
